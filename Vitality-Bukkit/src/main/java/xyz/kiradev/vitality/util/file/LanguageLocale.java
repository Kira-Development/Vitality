...
public enum LanguageLocale {
    ...
    // Punishment Stuff:
    SILENT_FORMAT("punishments.silent-format", "&7(Silent) "),
    UNBAN_BROADCAST("punishments.bans.unban-broadcast", "<silent><targetPlayer> &ahas been unbanned by <staffPlayer>&a."),
    BAN_BROADCAST("punishments.bans.ban-broadcast", "<silent><targetPlayer> &ahas been banned by <staffPlayer>&a."),
    MUTE_BROADCAST("punishments.mutes.mute-broadcast", "<silent><targetPlayer> &ahas been muted by <staffPlayer>&a."),
    UNMUTE_BROADCAST("punishments.mutes.unmute-broadcast", "<silent><targetPlayer> &ahas been unmuted by <staffPlayer>&a."),
    BLACKLIST_BROADCAST("punishments.blacklists.blacklist-broadcast", "<silent><targetPlayer> &ahas been blacklisted by <staffPlayer>&a."),
    UNBLACKLIST_BROADCAST("punishments.blacklists.unblacklist-broadcast", "<silent><targetPlayer> &ahas been unblacklisted by <staffPlayer>&a."),
    KICK_BROADCAST("punishments.kicks.kick-broadcast", "<silent><targetPlayer> &ahas been kicked by <staffPlayer>&a."),
    WARN_BROADCAST("punishments.warnings.warn-broadcast", "<silent><targetPlayer> &ahas been warned by <staffPlayer>&a."),
    UNWARN_BROADCAST("punishments.warnings.warn-broadcast", "<silent><targetPlayer> &ahas been unwarned by <staffPlayer>&a."),
